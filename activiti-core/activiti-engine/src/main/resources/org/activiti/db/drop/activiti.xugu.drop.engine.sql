drop index if exists ACT_RU_EXECUTION.ACT_IDX_EXEC_BUSKEY;
drop index if exists ACT_RU_TASK.ACT_IDX_TASK_CREATE;
drop index if exists ACT_RU_IDENTITYLINK.ACT_IDX_IDENT_LNK_USER;
drop index if exists ACT_RU_IDENTITYLINK.ACT_IDX_IDENT_LNK_GROUP;
drop index if exists ACT_RU_VARIABLE.ACT_IDX_VARIABLE_TASK_ID;
drop index if exists ACT_PROCDEF_INFO.ACT_IDX_INFO_PROCDEF;
...
drop index if exists ACT_RU_IDENTITYLINK.ACT_IDX_ATHRZ_PROCEDEF;
drop index if exists ACT_RU_EVENT_SUBSCR.ACT_IDX_EVENT_SUBSCR_CONFIG_;
